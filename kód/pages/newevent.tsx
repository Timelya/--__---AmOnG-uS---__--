					...
					<div className="square grid place-items-start md:place-items-center ...">
						...
						<form className="w-auto min-w-[25%] max-w-min mx-auto space-y-6 flex flex-col items-stretch"
							...
							<div style={{ color: "#9ca3af" }}>
								<div className="form">
									<input type="text" placeholder="Esemény neve"
										value={form.name}
								...
								<div className="form">
									<input type="datetime-local" placeholder="Esemény kezdete"
							...
							<button type="submit" className="Susbutton">
								<br /*<svg height="36px" width="36px" viewBox="0 0 36 36" xmlns="http://www.w3.org/2000/svg">
								...
								<span className="play">Létrehozás</span>
							</button>
						</form>
					</div>
				</div>
