...
const MakeEvent: NextPage<Event> = ({ events }) => {
	...
	function handleSubmit(data: FormData) {
		...
		if (!data.theme) {
			alert("Esemély témája nem lehet üres");
			return;
		}
						...
						>
							...
							<table className="tg">
								<tbody>
									...
									<tr>
										<td className="tg-0pky" colSpan={2}><input
											type="text"
											placeholder="Esemény leirás"
									...
									<tr>
										<td className="tg-0pky" rowSpan={2}><input
											type="datetime-local"
